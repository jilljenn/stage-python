...
project = u'Programme ton ordi en Python !' # e.g. How To Think Like a Computer Scientist
copyright = u'2014, Jill-Jênn Vie' # e.g. "2013, Brad Miller and David Ranum"
...
html_theme_options = {
    ...
    'navbar_title': "Programme ton ordi en Python !",
...
html_title = 'Programme ton ordi en Python !'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = u'Stage de programmation du 22 au 24 décembre'
